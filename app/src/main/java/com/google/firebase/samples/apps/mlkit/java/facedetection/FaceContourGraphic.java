...
//    canvas.drawRect(left, top, right, bottom, boxPaint);
    ...
    FirebaseVisionFaceContour contour = face.getContour(FirebaseVisionFaceContour.LOWER_LIP_BOTTOM);
    for (com.google.firebase.ml.vision.common.FirebaseVisionPoint point : contour.getPoints()) {
      ...
      Log.d("umerDebug1", String.valueOf(px));
      Log.d("umerDebug1", String.valueOf(py));
    }
    FirebaseVisionFaceContour contour2 = face.getContour(FirebaseVisionFaceContour.UPPER_LIP_TOP);
    for (com.google.firebase.ml.vision.common.FirebaseVisionPoint point : contour2.getPoints()) {
      float px = translateX(point.getX());
      float py = translateY(point.getY());
      canvas.drawCircle(px, py, FACE_POSITION_RADIUS, facePositionPaint);
      Log.d("umerDebug2", String.valueOf(px));
      Log.d("umerDebu2", String.valueOf(py));
    }
    ...
    for (com.google.firebase.ml.vision.common.FirebaseVisionPoint point : contour3.getPoints()) {
      ...
      float py = translateY(point.getY());
      canvas.drawCircle(px, py, FACE_POSITION_RADIUS, facePositionPaint);
      Log.d("umerDebug3", String.valueOf(px));
      Log.d("umerDebug3", String.valueOf(py));
    }
    ...
    for (com.google.firebase.ml.vision.common.FirebaseVisionPoint point : contour4.getPoints()) {
      ...
      float py = translateY(point.getY());
      canvas.drawCircle(px, py, FACE_POSITION_RADIUS, facePositionPaint);
      Log.d("umerDebug4", String.valueOf(px));
      Log.d("umerDebug4", String.valueOf(py));
    }
