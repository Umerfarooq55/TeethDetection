...
import com.google.firebase.samples.apps.mlkit.models.ImageUtils;
...
public final class LivePreviewActivity extends AppCompatActivity
    ...
    private FrameLayout frame, control;
...
//
        ...
        control = findViewById(R.id.control);
         imgbutton = findViewById(R.id.capture);
...
startActivity(new Intent(LivePreviewActivity.this, EditImageActivity.class));
    }
    public void retaketPicture(View view){
    ...
    public Bitmap viewToBitmap(View view) {
        ...
        FileOperations.saveImageToFileSystem(getApplicationContext()
                , byteArray, new FileOperations.AfterImageTaken() {
                    @Override
